...
export function LoginForm({ onForgotPassword, onSignUpClick }: LoginFormProps) {
  ...
  return (
    <div>
      ...
      <p className="text-gray-neutral600 mb-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-gray-neutral700 mb-1">
            Email
          </label>
          <input
            id="email"
            ...
            onChange={(e) => setEmail(e.target.value)}
            required
            className="w-full px-4 py-2 border border-gray-neutral300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            placeholder="you@example.com"
          />
        </div>

        <div>
          <label htmlFor="password" className="block text-sm font-medium text-gray-neutral700 mb-1">
            Password
          </label>
          <input
            id="password"
