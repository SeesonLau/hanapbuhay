// components/buttons/SearchButton.tsx
...
const SearchButton: React.FC<ButtonProps> = ({ 
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`w-36 h-16 rounded-[50px] inline-flex justify-center items-center gap-2.5 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 ${className}`}
      style={{ 
